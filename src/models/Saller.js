...
export default class Saller extends Model {
  static init(sequelize) {
    ...
    this.addHook('beforeSave', async (saller) => {
      if (saller.password) {
        saller.password_hash = await bcryptjs.hash(saller.password, 8);
      }
    });
    return this;
  }
  ...
  static associate(models) {
    this.hasMany(models.Product, { foreignKey: 'saller_id' });
  }
}
